                ...
                <div className="flex items-center justify-between gap-3 flex-wrap">
                  <div className="min-w-0">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {due && (
                        <span className="text-xs font-mono uppercase tracking-wide px-2 py-0.5 rounded-full" style={{ background: 'var(--tally-progress-soft)', color: 'var(--tally-progress-text)' }}>
                          Due now
                        </span>
                      )}
                    </div>
