...
const ENTITY_LABELS = { task: 'Task', ticket: 'Ticket', invoice: 'Invoice', project: 'Project', client: 'Client' }
...
export default function ActivityLog({ projectId, entityType, entityId, title = 'Activity' }) {
  ...
  const linkFor = (entry) => {
    ...
    if (entry.entity_type === 'client') return projectId ? null : `/clients/${entry.entity_id}`
    return null
  }
