...
//
// Three tables hold live credentials (Google's OAuth tokens, Wise's API
// token, MFA backup code hashes) and are deliberately NOT included whole
// -- see SENSITIVE_COLUMNS below. Losing those in a restore just means
// reconnecting Google Calendar/Wise or regenerating backup codes, a
...
const SKIP_TABLES = new Set(['rate_limit_events'])
